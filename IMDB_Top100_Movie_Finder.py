...
def Movie_List_Maker(url):
    ...
    movie_list = list()
    ratings = list()
    if url == "https://www.imdb.com/search/title/?groups=top_100&sort=user_rating,desc":
...
Movie_List_Maker("https://www.imdb.com/search/title/?groups=top_100&sort=user_rating,desc")
Movie_List_Maker("https://www.imdb.com/search/title/?groups=top_100&sort=user_rating,desc&start=51&ref_=adv_nxt")